	...
	public void startAnimationsIn(int durationMillis) {
		...
		*/
		for (int i = 0; i < clayout.getChildCount(); i++) {
			...
			Animation animation = new TranslateAnimation(5, (float)(xOri* deltaX), -5, (float)(yOri* deltaY));
			/*
	...
	*/
	public void startAnimationsOut( int durationMillis) {
		for (int i = 0; i < clayout.getChildCount(); i++) {
			...
			Animation animation = new TranslateAnimation(0,-(float)(xOri*deltaX-5), 0,  -(float)(yOri*deltaY)-5);
			//animation.setFillAfter(true);
			animation.setDuration(durationMillis);
